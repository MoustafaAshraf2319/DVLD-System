...
namespace DVLD_Buisness
{
    public class clsApplication
    {
        ...
        {
            this.ApplicationID = DVLD_DataAccess.clsApplicationData.AddNewApplication(
        ...
        {
            return DVLD_DataAccess.clsApplicationData.UpdateApplication(this.ApplicationID, this.ApplicantPersonID, this.ApplicationDate,
                this.ApplicationTypeID, (byte)this.ApplicationStatus,
                this.LastStatusDate, this.PaidFees, this.CreatedByUserID);
        }
        ...
        public static clsApplication FindBaseApplication(int ApplicationID)
        {
            ...
            bool IsFound = DVLD_DataAccess.clsApplicationData.GetApplicationInfoByID(ApplicationID, ref ApplicantPersonID, ref ApplicationDate,
        ...
        public bool Cancel()
        {
            return DVLD_DataAccess.clsApplicationData.UpdateStatus(ApplicationID, 2);
        }

        public bool SetComplete()
        {
            return DVLD_DataAccess.clsApplicationData.UpdateStatus(ApplicationID, 3);
        }
        ...
        public bool Delete()
        {
            return DVLD_DataAccess.clsApplicationData.DeleteApplication(this.ApplicationID);
        }
        ...
        {
            return DVLD_DataAccess.clsApplicationData.DoesPersonHaveActiveApplication(PersonID, ApplicationTypeID);
        }
