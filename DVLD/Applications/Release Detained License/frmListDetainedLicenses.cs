    ...
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            if(FilterColumn == "DetainID" || FilterColumn == "ReleaseApplicationID")
                _dtDetainedLicenses.DefaultView.RowFilter = string.Format("[{0}] = {1}", FilterColumn, txtFilterValue.Text);
            else
                _dtDetainedLicenses.DefaultView.RowFilter = string.Format("[{0}] LIKE '{1}%'", FilterColumn, txtFilterValue.Text); 
